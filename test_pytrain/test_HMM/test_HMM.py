...
class test_HMM(test_Suite):
    ...
    def test_process(self):
        ...
        train_label = [\
                     ...
                     [2,2,2,1,2,2,1,1,2,2,2,1,2,2,2,1],\
                    ]
        ...
        r1 = autotest.eval_predict_one(hmm, ti1, [2,1,2,1,2,2,2,1], self.logging)

        ti2 = nlp_common.set_of_wordseq2matrix(voca,['<s>','Y','o','u','a','r','e','a','b','o','y'])
        r2 = autotest.eval_predict_one(hmm, ti2, [2,2,2,1,2,2,1,1,2,2,1], self.logging)
...
class test_HMM_BaumWelch(test_Suite):
    ...
    def test_process(self):
        ...
        hmm.fit(toler = 0.001, epoch = 1000)
